                    ...
                    return   ElevatedButton.icon(onPressed:(){
                      ...
                      // full payment
                        if(_am.text != null  && int.parse(_am.text) == int.parse(widget.tot)){
                          ...
                          var bal= (int.parse(widget.tot)-int.parse(_am.text));

                          // print(bal);
                          // print(_am.text);
                          // print('This is full payment');
                        ...
                        //part payment
                        else if(_am.text != null  && int.parse(_am.text) < int.parse(widget.tot)){

                          var balo= (int.parse(widget.tot) - int.parse(_am.text));
