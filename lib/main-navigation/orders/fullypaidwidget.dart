...
class FullPaidWidget extends StatefulWidget {
  const FullPaidWidget({super.key});

  @override
  State<FullPaidWidget> createState() => _FullPaidWidgetState();
}

class _FullPaidWidgetState extends State<FullPaidWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Provider.of<OrdersProvider>(context,listen: false).getFull();
    });
  }
